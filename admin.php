...
<head>
    ...
    <link href="lib/tempusdominus/css1/tempusdominus-bootstrap-4.min.css" rel="stylesheet" />
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="request.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Make request</a>
                    <a href="download.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Courses</a>
                    <a href="upload-file.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Upload courses</a>
                    <a href="counselling.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Counsel</a>
                    <!-- <div class="nav-item dropdown">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $data["t_id"]; ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $data1["total"]; ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Experts</p>
                                <h6 class="mb-0"><?php echo $data["t_expert"]; ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">Total experts</h6>
                                 <a href="">Show All</a> 
                            </div>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Course_material</a>, All Right Reserved. 
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                            Designed By <a href="https://htmlcodex.com">SLow_n_Tidy</a>
